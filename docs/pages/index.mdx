...
useWallet is a collection of React Hooks containing everything you need to start working with Casper Network. Makes it easy to "Connect Casper Wallet," sign messages, interact with contracts, and much more.
