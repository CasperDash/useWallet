...
declare class CasperDashConnector extends Connector<CasperDashWindowGlobal, Window, CasperDashConnectorOptions> {
    readonly id: string;
    private provider;
...
type CasperSignerConnectorOptions = {
    name?: string;
    getProvider?: () => Provider | undefined;
    getEventProvider?: () => EventProvider;
};
declare class CasperSignerConnector extends Connector<CasperLabWindowGlobal, Window, CasperSignerConnectorOptions> {
    readonly id: string;
    private provider;
    private eventProvider;
    constructor({ options: defaultOptions, }?: {
...
declare class Client {
    ...
    protected autoConnect(): Promise<ConnectorData<unknown> | undefined>;
...
export { Account, Acount, CasperDashConnector, CasperDashConnectorOptions, CasperSignerConnector, CasperSignerConnectorOptions, Client, ClientConfig, ClientNotFoundError, ConnectParams, ConnectResult, Connector, ConnectorAlreadyConnectedError, ConnectorData, ConnectorEvents, ConnectorNotFoundError, SignMessageParams, SignMessageResult, SignParams, SignResult, StateParams, StatusEnum, WatchAccountOptions, WatchAccountSelectorParams, client, connect, createClient, deepEqual, disconnect, getAccount, getActivePublicKey, getClient, isConnected, sign, signMessage, watchAccount };
